    ...
    return Scaffold(
      ...
      body: Center(
        ...
        child: Column(
          ...
          children: <Widget>[
            Text("Tip Calculator", style: Theme.of(context).textTheme.titleLarge),
            SizedBox(height: 100),
            Text("Bill Amount"),
            ...
            ElevatedButton(
              ...
              child: Text("Convert Tip"),
            ),
            SizedBox(height: 30),
            Text("Total Tip: " + _tip.toStringAsFixed(2)),
          ],
        ),
      ),
